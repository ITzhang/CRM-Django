    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classstudyrecord', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_manage.ClassStudyRecord', verbose_name='第几天课程')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student_manage.Student', verbose_name='学员')),
            ],
        ),
    ]
